...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CROSSFIT EVT - EVOLVE — Box Oficial de CrossFit | Várzea, Teresópolis" },
      { name: "description", content: "Equipamentos novos, professores certificados, comunidade acolhedora e adaptação para iniciantes na Rua Chaves Faria, 182." },
      { property: "og:title", content: "CROSSFIT EVT - EVOLVE — Box de CrossFit" },
      { property: "og:description", content: "Supere seus limites no melhor box de CrossFit com acolhimento para iniciantes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='%2309090b'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='%23f97316' font-family='sans-serif' font-weight='900' font-size='36'>EVT</text></svg>" },
